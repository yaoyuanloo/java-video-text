...
function siMenu(id,fid,MENU_NAME,MENU_URL){
	...
	//if(MENU_URL != "druid/index.html"){
		jzts();
		$("#Conframe").attr("src",locat+"/"+MENU_URL);
	//}
}
...
function editUserH(){
	...
	/* var diag = new top.Dialog();
	 ...
	 diag.show();*/
	 $("#Conframe").attr("src",locat+'/user/goEditU.do?USER_ID='+USER_ID+'&fx=head');
}
...
function menuUrl(obj){
	if(obj && $(obj).attr("url")){
		$("#Conframe").attr("src",locat+$(obj).attr("url")+'?USER_ID='+USER_ID+'&fx=head');
	}
}